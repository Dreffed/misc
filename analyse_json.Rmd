...
schema_opts = {
    ...
    "md_fields": ["type", "sqltype", "encountered", "field_type"], # "type", "sqltype", "length", "value", "encountered"
    "cfg_fields": ["updated", "update", "--updated", "checked"], #"updated", "update", "--updated"
}
...
for f in scan_files(folder=scan_path, options=config.get("scan_options", {})):
    if f.get("ext","") in config.get("locations",{}).get("sources",{}).get("filter",{}).get("exts",[]):
